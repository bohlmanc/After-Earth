...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
		...
		[SerializeField] private float m_crouch_speed;
		...
		public float jump_stamina_required;
...
//        	print(stamina);
            ...
            // If the player was in the air last frame and is now on the ground, land the player
        ...
        private void FixedUpdate ()
		{
			...
			if (m_CharacterController.isGrounded) {
				...
				if (m_Jump) {	
					if (stamina > jump_stamina_required) {
						stamina -= (float) .5;
